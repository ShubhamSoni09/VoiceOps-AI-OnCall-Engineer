...
1. intent - one of: investigate_incident, fix_issue, deploy_service, check_status, rollback_deployment, run_tests, create_pr, general_query, unknown
2. action - one of: investigate, diagnose, patch, test, create_pr, deploy, verify, rollback, status, unknown
